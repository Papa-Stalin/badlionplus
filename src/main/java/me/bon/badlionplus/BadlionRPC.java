...
public class BadlionRPC {
    private static final String ClientId = "760293346480095262";
    ...
    public static void init(){
        ...
        presence.state = "Menu";
        presence.largeImageKey = "badlionplus";
        presence.largeImageText = "Created by bon";
        presence.smallImageKey = "yellowplus";
